                ...
                <div className="itoffcanvas__info-address">
                  ...
                  <a href="maito:hello@yourmail.com">
                    <span
                      ...
                      data-cfemail="f79f929b9b98b78e9882859a969e9bd994989a"
                    >
                      [email&nbsp;protected]
                    </span>
                  </a>
                  ...
                  <div className="col-xl-8 col-lg-8 col-md-5 col-sm-4">
                    <div className="it-header-2-top-left">
                      <ul className="text-center text-sm-start">
                        ...
                        <li>
                          <a href="https://ordainit.com/cdn-cgi/l/email-protection#63040c150a0f0f02040623040e020a0f4d000c0e">
                            <span>
                              <svg
                                width={20}
                                height={20}
                            ...
                            <span
                              className="__cf_email__"
                              data-cfemail="6d0a021b0401010c0a082d0a000c0401430e0200"
                            ></span>
                          </a>
                        </li>
                            ...
                            <ul>
                              ...
                              <li className="has-dropdown">
                                ...
                                <ul className="it-submenu submenu">
                                  ...
                                  <li>
                                    <a href="services-2.html">Türkçe</a>
                                  </li>
                                  <li>
